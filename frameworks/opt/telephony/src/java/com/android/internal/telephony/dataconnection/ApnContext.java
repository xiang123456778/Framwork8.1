...
public class ApnContext {
     ...
     */
    protected RetryManager mRetryManager;
    ...
    protected final ArrayList<LocalLog> mLocalLogs = new ArrayList<>();
    protected final ArrayList<NetworkRequest> mNetworkRequests = new ArrayList<>();
    protected final ArrayDeque<LocalLog> mHistoryLogs = new ArrayDeque<>();
    protected final static int MAX_HISTORY_LOG_COUNT = 4;
