...
public class SubscriptionController extends ISub.Stub {
    ...
    protected /*private*/ AtomicReference<List<SubscriptionInfo>> mCacheActiveSubInfoList = new AtomicReference();
    // MTK-END
    ...
    protected /*private*/ int[] colorArr;
    // MTK-END
    ...
    // MTK-START
    protected /*private*/ boolean isSubInfoReady() {
    // MTK-END
     ...
     */
    // MTK-START
    protected /*private*/ boolean canReadPhoneState(String callingPackage, String message) {
    // MTK-END
        try {
     ...
     */
    // MTK-START
    protected /*private*/ int getUnusedColor(String callingPackage) {
    // MTK-END
     ...
     */
    // MTK-START
    protected /*private*/ int setCarrierText(String text, int subId) {
    // MTK-END
    ...
    // MTK-START
    protected /*private*/ void validateSubId(int subId) {
    // MTK-END
