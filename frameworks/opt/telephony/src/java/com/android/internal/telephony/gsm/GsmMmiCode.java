...
*/
    ...
    protected String getScStringFromScType(SsData.ServiceType sType) {
        switch (sType) {
            case SS_CFU:
                return SC_CFU;
            case SS_CF_BUSY:
    ...
    protected String getActionStringFromReqType(SsData.RequestType rType) {
        switch (rType) {
            case SS_ACTIVATION:
    ...
    protected boolean isServiceClassVoiceorNone(int serviceClass) {
...
*/
     ...
     * such.
     */
    static protected boolean isShortCode(String dialString, GsmCdmaPhone phone) {
     ...
     */
    static protected boolean isShortCodeUSSD(String dialString, GsmCdmaPhone phone) {
    ...
    protected void handlePasswordError(int res) {
        mState = State.FAILED;
