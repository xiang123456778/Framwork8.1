...
public class ServiceStateTracker extends Handler {
    ...
    */
    ...
    protected final LocalLog mTimeLog = new LocalLog(15);
    protected final LocalLog mTimeZoneLog = new LocalLog(15);
    ...
    protected static final int MAX_NITZ_YEAR = 2037;
    /**
    ...
    protected int mNitzUpdateSpacing = SystemProperties.getInt("ro.nitz_update_spacing",
    ...
    protected int mNitzUpdateDiff = SystemProperties.getInt("ro.nitz_update_diff",
    ...
    protected void processCellLocationInfo(CellLocation cellLocation,
    ...
    protected int getLteEarfcn(DataRegStateResult dataRegStateResult) {
    ...
    protected int getRegStateFromHalRegState(int regState) {
        switch (regState) {
    ...
    protected void saveNitzTime(long time) {
        mSavedTime = time;
    ...
    protected void updateLteEarfcnLists() {
        CarrierConfigManager configManager = (CarrierConfigManager)
                mPhone.getContext().getSystemService(Context.CARRIER_CONFIG_SERVICE);
