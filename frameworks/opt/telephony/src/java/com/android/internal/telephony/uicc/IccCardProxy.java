...
public class IccCardProxy extends Handler implements IccCard {
    ...
    //MTK START: add-on
    protected static final String LOG_TAG = "IccCardProxy";
    //MTK END
    private static final int EVENT_RADIO_OFF_OR_UNAVAILABLE = 1;
    private static final int EVENT_RADIO_ON = 2;
    //MTK START: add-on
    protected static final int EVENT_ICC_CHANGED = 3;
    //MTK END
    ...
    //MTK START: add-on
    protected static final int EVENT_CARRIER_PRIVILEGES_LOADED = 503;
    protected Integer mPhoneId = null;
    ...
    protected RadioState mRadioState = RadioState.RADIO_UNAVAILABLE;
...
//        setExternalState(State.DETECTED, false);
    ...
    //MTK END
        synchronized (mLock) {
            ...
            IntentBroadcaster.getInstance(mContext).broadcastStickyIntent(intent, mPhoneId);
        }
    }
