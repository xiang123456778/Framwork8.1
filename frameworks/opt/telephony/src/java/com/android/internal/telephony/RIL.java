...
public class RIL extends BaseCommands implements CommandsInterface {
    ...
    protected class RilHandler extends Handler {
     ...
     */
    protected static int convertToHalMvnoType(String mvnoType) {
        switch (mvnoType) {
     ...
     */
    protected static DataProfileInfo convertToHalDataProfile(DataProfile dp) {
