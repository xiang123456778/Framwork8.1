...
public class SIMRecords extends IccRecords {
    ...
    // MTK SATRT: add-on
    protected static final boolean CRASH_RIL = false;
    // MTK END
    ...
    protected SpnOverride mSpnOverride;
    ...
    byte[] mEfCfis = null;
    // MTK SATRT: add-on
    protected byte[] mEfLi = null;
    protected byte[] mEfPl = null;
    ...
    // ***** Event Constants
    // MTK SATRT: add-on
    protected static final int SIM_RECORD_EVENT_BASE = 0x00;
    protected static final int EVENT_GET_IMSI_DONE = 3 + SIM_RECORD_EVENT_BASE;
    protected static final int EVENT_GET_ICCID_DONE = 4 + SIM_RECORD_EVENT_BASE;
    ...
    protected static final int EVENT_GET_VOICE_MAIL_INDICATOR_CPHS_DONE = 8 + SIM_RECORD_EVENT_BASE;
    ...
    protected static final int EVENT_GET_SPDI_DONE = 13 + SIM_RECORD_EVENT_BASE;
    ...
    protected static final int EVENT_GET_ALL_SMS_DONE = 18 + SIM_RECORD_EVENT_BASE;
    protected static final int EVENT_MARK_SMS_READ_DONE = 19 + SIM_RECORD_EVENT_BASE;
    // MTK END
    ...
    protected static final int EVENT_GET_GID1_DONE = 34 + SIM_RECORD_EVENT_BASE;
    protected static final int EVENT_GET_GID2_DONE = 36 + SIM_RECORD_EVENT_BASE;

    protected static final int EVENT_GET_PLMN_W_ACT_DONE = 37 + SIM_RECORD_EVENT_BASE;
    protected static final int EVENT_GET_OPLMN_W_ACT_DONE = 38 + SIM_RECORD_EVENT_BASE;
    protected static final int EVENT_GET_HPLMN_W_ACT_DONE = 39 + SIM_RECORD_EVENT_BASE;
    protected static final int EVENT_GET_EHPLMN_DONE = 40 + SIM_RECORD_EVENT_BASE;
    protected static final int EVENT_GET_FPLMN_DONE = 41 + SIM_RECORD_EVENT_BASE;
    // MTK END
    ...
    // MTK START: add-on
    protected void handleSimRefresh(IccRefreshResponse refreshResponse){
    // MTK END
    ...
    // MTK SATRT: add-on
    protected void handleCarrierNameOverride() {
    // MTK END
        CarrierConfigManager configLoader = (CarrierConfigManager)
                mContext.getSystemService(Context.CARRIER_CONFIG_SERVICE);
    ...
    // MTK SATRT: add-on
    protected void loadEfLiAndEfPl() {
    // MTK END
        if (mParentApp.getType() == AppType.APPTYPE_USIM) {
