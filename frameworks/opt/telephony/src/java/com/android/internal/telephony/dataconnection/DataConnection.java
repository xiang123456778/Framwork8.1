...
public class DataConnection extends StateMachine {
    ...
    protected static int CMD_TO_STRING_COUNT =
    ...
    public static DataConnection makeDataConnection(Phone phone, int id,
        ...
        DataConnection dc = telephonyComponentFactory.makeDataConnection(phone,
    ...
    public DataConnection(Phone phone, String name, int id,
                DcTracker dct, DcTesterFailBringUpAll failBringUpAll,
                DcController dcc) {
    ...
    protected void onConnect(ConnectionParams cp) {
        ...
        TelephonyComponentFactory telephonyComponentFactory
                = TelephonyComponentFactory.getInstance();
        DataProfile dp = telephonyComponentFactory.makeDataProfile(mApnSetting, cp.mProfileId);
    ...
    protected void notifyAllOfConnected(String reason) {
     ...
     */
    protected void notifyConnectCompleted(ConnectionParams cp, DcFailCause cause, boolean sendAll) {
     ...
     * @return SetupResult.
     */
    protected DataCallResponse.SetupResult onSetupConnectionCompleted(AsyncResult ar) {
    ...
    protected DataCallResponse.SetupResult setLinkProperties(DataCallResponse response,
            LinkProperties lp) {
     ...
     */
    protected boolean initConnection(ConnectionParams cp) {
        ApnContext apnContext = cp.mApnContext;
        if (mApnSetting == null) {
    ...
    protected boolean updateNetworkInfoSuspendState() {
     ...
     */
    protected long getSuggestedRetryDelay(AsyncResult ar) {
