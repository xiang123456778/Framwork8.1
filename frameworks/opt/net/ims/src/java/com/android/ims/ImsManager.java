...
public class ImsManager {
    ...
    protected final ImsRegistrationListenerProxy mRegistrationListenerProxy =
    ...
    public static void factoryReset(Context context) {
        /// M: Revise for telephony add-on @{
        if (sMtkImsManager != null) {
            try {
                Method mtkMethod = sMtkImsManager.getMethod(
                        "factoryReset",
                        new Class[] {Context.class});
                mtkMethod.invoke(null, context);
                return;
            } catch (Exception e) {
                loge("MtkImsManager.factoryReset() not found! Used AOSP instead! e: " + e);
            }
        }
        /// @}
