...
public class SubscriptionInfo implements Parcelable {
     ...
     * @hide
     */
    protected /*private*/ static final int TEXT_SIZE = 16;
     ...
     * @hide
     */
    protected /*private*/ int mSimSlotIndex;

    /**
     * The name displayed to the user that identifies this subscription
     * @hide
     */
    protected /*private*/ CharSequence mDisplayName;
     ...
     * @hide
     */
    protected /*private*/ CharSequence mCarrierName;
     ...
     * @hide
     */
    protected /*private*/ int mNameSource;

    /**
     * The color to be used for tinting the icon when displaying to the user
     * @hide
     */
    protected /*private*/ int mIconTint;

    /**
     * A number presented to the user identify this subscription
     * @hide
     */
    protected /*private*/ String mNumber;

    /**
     * Data roaming state, DATA_RAOMING_ENABLE, DATA_RAOMING_DISABLE
     * @hide
     */
    protected /*private*/ int mDataRoaming;

    /**
     * SIM Icon bitmap
     * @hide
     */
    protected /*private*/ Bitmap mIconBitmap;

    /**
     * Mobile Country Code
     * @hide
     */
    protected /*private*/ int mMcc;

    /**
     * Mobile Network Code
     * @hide
     */
    protected /*private*/ int mMnc;

    /**
     * ISO Country code for the subscription's provider
     * @hide
     */
    protected /*private*/ String mCountryIso;
    // MTK-END
