...
public class PhoneNumberUtils
{
     ...
     * @hide
     */
    protected /*private*/ static boolean isNonSeparator(String address) {
        for (int i = 0, count = address.length(); i < count; i++) {
     ...
     * @hide
     */
    protected /*private*/ static final char PLUS_SIGN_CHAR = '+';
    /**
     * @hide
     */
    protected /*private*/ static final String PLUS_SIGN_STRING = "+";
     ...
     * @hide
     */
    protected /*private*/ static int getFormatTypeFromCountryCode (String country) {
    ...
    */
     ...
     * @hide
     */
    protected /*private*/ static int findDialableIndexFromPostDialStr(String postDialStr) {
     ...
     * @hide
     */
    protected /*private*/ static String
