...
public class IpManager extends StateMachine {
    ...
    /// M: ALPS03051043: pass IP recover switch  @{
    public void completedPreDhcpAction(boolean isIpRecover) {
        sendMessage(EVENT_PRE_DHCP_ACTION_COMPLETE, isIpRecover);
    }
    /// @}
            ...
            switch (msg.what) {
                ...
                case EVENT_PRE_DHCP_ACTION_COMPLETE:
                    ...
                    if (mDhcpClient != null) {
                        /// M: ALPS03051043: pass ip recover switch  @{
                        if (msg.obj != null) {
                            boolean isIpRecover = (boolean) msg.obj;
