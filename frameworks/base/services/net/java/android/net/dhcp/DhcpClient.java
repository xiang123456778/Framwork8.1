...
import android.net.arp.ArpPeer;  /// M: for auto-ip
...
public class DhcpClient extends StateMachine {
        ...
        public boolean processMessage(Message message) {
            ...
            switch (message.what) {
                case CMD_PRE_DHCP_ACTION_COMPLETE:
                    ...
                    if (message.obj != null) {
                        mIsIpRecoverEnabled = (boolean) message.obj;
                    }
    ...
    private boolean setIpAddress(LinkAddress address) {
        ...
        try {
            ...
            Log.e(TAG, "setIpAddress(): configured IP address " + address + ": ", e);
            return false;
        }
        return true;
    }
    ...
    private boolean doIpRecover() {
        ...
        try {
            ...
            Log.d(TAG, "IP recover: arp address = " +
                "#$%K" +
            ...
            if (arpResult == null) {
                ...
                Log.d(TAG, "IP recover: no arp response, IP can be reused");
                return true;
            } else {
                Log.d(TAG, "IP recover: DAD detected!!");
            }
        } catch (ErrnoException | IllegalArgumentException | SocketException e) {
            Log.e(TAG, "IP recover: doIpRecover() meet " + e);
        } finally {
            if (ap != null)    ap.close();
        }
        return false;
