...
class DatabaseHelper extends SQLiteOpenHelper {
    ...
    private void loadSystemSettings(SQLiteDatabase db) {
        ...
        try {
            ...
            /// M: Load mtk system settings default value @{
            loadMtkSettings("loadMtkSystemSettings", stmt);
            /// @}
    ...
    private void loadSecureSettings(SQLiteDatabase db) {
        ...
        try {
            ...
            /// M: Load mtk secure settings default value @{
            loadMtkSettings("loadMtkSecureSettings", stmt);
            /// @}
    ...
    private void loadGlobalSettings(SQLiteDatabase db) {
        ...
        try {
            ...
            /// M: Load mtk global settings default value @{
            loadMtkSettings("loadMtkGlobalSettings", stmt);
            /// @}
    ...
    /// M: Mtk add ext Settings loader class @{
    private final String className = "com.mediatek.provider.MtkSettingsProviderExt";
    private Object mInstance;

    private void initMtkSettings() {
        try {
            Class<?> extSettingsProvider = Class.forName(className, false,
                    ClassLoader.getSystemClassLoader());
            Constructor constructor  = extSettingsProvider.getConstructor(Context.class);
            mInstance = constructor.newInstance(mContext);
        } catch (Exception  e) {
            Log.e(TAG, "No MtkSettingsProviderExt! Do nothing. - " , e);
        }
    }

    private void loadMtkSettings(String methodName, SQLiteStatement stmt) {
        try {
            Class<?> extSettingsProviderCls = Class.forName(className, false,
                    ClassLoader.getSystemClassLoader());
            Class paraClass[] = {SQLiteStatement.class};
            Method loadMtkSettingsMethod
                = extSettingsProviderCls.getDeclaredMethod(methodName, paraClass);
            loadMtkSettingsMethod.setAccessible(true);
            loadMtkSettingsMethod.invoke(mInstance, stmt);
        } catch (Exception e) {
            Log.e(TAG, "No MtkSettingsProviderExt! Do nothing.", e);
        }
    }
