...
public final class NetworkCapabilities implements Parcelable {
    ...
    /** M: modify MAX_NET_CAPABILITY to NET_CAPABILITY_BIP */
    ...
    public static String capabilityNameOf(int capability) {
        switch (capability) {
            ...
            /** M: start */
            case NET_CAPABILITY_DM:             return "DM";
            case NET_CAPABILITY_WAP:            return "WAP";
            case NET_CAPABILITY_NET:            return "NET";
            case NET_CAPABILITY_CMMAIL:         return "CMMAIL";
            case NET_CAPABILITY_TETHERING:      return "TETHERING";
            case NET_CAPABILITY_RCSE:           return "RCSE";
