...
/*static*/ const char * const AudioPolicyEffects::kInputSourceNames[AUDIO_SOURCE_CNT -1] = {
    ...
    VOICE_REC_SRC_TAG,
    VOICE_COMM_SRC_TAG,
    MTK_RESERVED_SRC_TAG,   // MTK_AUDIO AOSP miss for AUDIO_SOURCE_REMOTE_SUBMIX
    UNPROCESSED_SRC_TAG,    // 9
    MTK_RESERVED_SRC_TAG,   // 10
    MTK_RESERVED_SRC_TAG,   // 11
    MTK_RESERVED_SRC_TAG,
    MTK_RESERVED_SRC_TAG,
    MTK_RESERVED_SRC_TAG,
    MTK_RESERVED_SRC_TAG,
    MTK_RESERVED_SRC_TAG,
    ...
    MTK_RESERVED_SRC_TAG,
    MTK_RESERVED_SRC_TAG,
    VOICE_UNLOCK_SRC_TAG,   // MTK_AUDIO 80
    CUSTOMIZATION1_SRC_TAG, // MTK_AUDIO 81
    CUSTOMIZATION2_SRC_TAG, // MTK_AUDIO 82
    CUSTOMIZATION3_SRC_TAG, // MTK_AUDIO 83
};
