...
// <MTK_AUDIO
#if defined(MTK_AUDIO_DEBUG)
static const char * AF_PARAM_KEY[] = {
    AudioParameter::keyAudioDumpMixer,
    AudioParameter::keyAudioDumpTrack,
    AudioParameter::keyAudioDumpOffload,
    AudioParameter::keyAudioDumpResampler,
    AudioParameter::keyAudioDumpMixerEnd,
    AudioParameter::keyAudioDumpRecord,
    AudioParameter::keyAudioDumpEffect,
    AudioParameter::keyAudioDumpDrc,
    AudioParameter::keyAudioDumpLog,
    };
#endif // MTK_AUDIO_DEBUG
// MTK_AUDIO>
// ----------------------------------------------------------------------------
