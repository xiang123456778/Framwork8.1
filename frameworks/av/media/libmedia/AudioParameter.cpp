...
// <MTK_AUDIO
const char * const AudioParameter::keyAudioDumpMixer = "af.mixer.pcm";
const char * const AudioParameter::keyAudioDumpTrack = "af.track.pcm";
const char * const AudioParameter::keyAudioDumpOffload = "af.offload.write.raw";
const char * const AudioParameter::keyAudioDumpResampler = "af.resampler.pcm";
const char * const AudioParameter::keyAudioDumpMixerEnd = "af.mixer.end.pcm";
const char * const AudioParameter::keyAudioDumpRecord = "af.record.dump.pcm";
const char * const AudioParameter::keyAudioDumpEffect = "af.effect.pcm";
const char * const AudioParameter::keyAudioDumpDrc = "af.mixer.drc.pcm";
const char * const AudioParameter::keyAudioDumpLog = "af.dumplog";
// MTK_AUDIO>
