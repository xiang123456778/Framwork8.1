...
const OutputDeviceConverter::Table OutputDeviceConverter::mTable[] = {
    ...
    MAKE_STRING_FROM_ENUM(AUDIO_DEVICE_OUT_USB_PRIMARY),    // MTK_AUDIO
...
const InputDeviceConverter::Table InputDeviceConverter::mTable[] = {
    ...
    MAKE_STRING_FROM_ENUM(AUDIO_DEVICE_IN_USB_PRIMARY), // MTK_AUDIO
    // STUB must be after DEFAULT, so the latter is picked up by toString first.
...
const InputChannelConverter::Table InputChannelConverter::mTable[] = {
    ...
    MAKE_STRING_FROM_ENUM(AUDIO_CHANNEL_IN_VOICE_UPLINK),   // MTK_AUDIO
    MAKE_STRING_FROM_ENUM(AUDIO_CHANNEL_IN_VOICE_DNLINK),   // MTK_AUDIO
    TERMINATOR
};
...
const SourceTypeConverter::Table SourceTypeConverter::mTable[] = {
    ...
    MAKE_STRING_FROM_ENUM(AUDIO_SOURCE_VOICE_UNLOCK),   // MTK_AUDIO
    MAKE_STRING_FROM_ENUM(AUDIO_SOURCE_CUSTOMIZATION1), // MTK_AUDIO
    MAKE_STRING_FROM_ENUM(AUDIO_SOURCE_CUSTOMIZATION2), // MTK_AUDIO
    MAKE_STRING_FROM_ENUM(AUDIO_SOURCE_CUSTOMIZATION3), // MTK_AUDIO
